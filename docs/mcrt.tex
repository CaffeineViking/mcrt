    ...
    \section{Results and Benchmark} \label{sec:results_and_benchmark}
        ...
        \subsection*{Parameter Benchmarks}
            ...
            \begin{tabular}{lll}
                ...
                \midrule
                1&See Fig.~\ref{fig:supersamples_1}&3.1254\\
                16&See Fig.~\ref{fig:supersamples_16}&50.35\\
                49&See Fig.~\ref{fig:default}&162.2\\
                196&See Fig.~\ref{fig:supersamples_192}&624.7\\
                \bottomrule
            \end{tabular}
            \label{tab:shadow_rays}
            \end{table}
            ...
            \begin{figure}[H]
                \centering
                \caption{Render of the scene 512x512 at 192 samples per pixel, 1 shadow ray and 7 max ray bounces.}
                \includegraphics[width=0.8\linewidth]{share/results/supersamples_16.png}
