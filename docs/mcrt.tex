    ...
    \section{Results and Benchmark} \label{sec:results_and_benchmark}
        ...
        \subsection*{Final Render}
            ...
            \begin{figure}[H]
                ...
                \caption{High-resolution render of the scene at 1024x1024 using 1024 SPP, 1 shadow ray and 7 ray bounces.}
                \label{fig:render}
            \end{figure}
            ...
            Sphere with a perfectly reflective surface where both different geometrical surfaces which aren't visible in the original viewplane can be observed as well as some fresnel effects on the grazing angles of the sphere. 

            \begin{figure}[H]
                \centering
                \includegraphics[width=\linewidth]{share/new_render_reflection.png}
                \label{fig:render_reflection}
            \end{figure}

            \subsubsection*{Refraction}

            Sphere with perfectly refractive material with an refractive index similar to glass. The convex lens which the sphere creates causes a mirrored refracted projection. As with the reflective sphere, some fresnel effects can be observed.
            \begin{figure}[H]
                \centering
                \includegraphics[width=\linewidth]{share/new_render_refraction.png}
            ...
            \begin{figure}[H]
                \centering
                \includegraphics[width=\linewidth]{share/new_render_caustics.png}
        ...
        \subsection*{Parameter Benchmarks}
            ...
            \begin{figure}[H]
                \centering
                \caption{}
                \includegraphics[width=\linewidth]{share/results/default.png}
                \label{fig:default}
            \end{figure}
            ...
            \begin{figure}[H]
                \centering
                \caption{}
                \includegraphics[width=\linewidth]{share/results/shadow_rays_4.png}
            ...
            \begin{tabular}{llllll}
                \toprule
                \textbf{Shadow Rays}&\textbf{Figure}&\textbf{Render Time}&\\
                \midrule
                1&Figure~\ref{fig:default}&162.2 seconds\\
                4&Figure~\ref{fig:shadow_rays_4}&446.1 seconds\\
                8&Figure~\ref{fig:shadow_rays_8}&0.0\\
                \bottomrule
            \end{tabular}
            \label{tab:shadow_rays}
            \end{table}

            \subsubsection*{Number of Bounces}
